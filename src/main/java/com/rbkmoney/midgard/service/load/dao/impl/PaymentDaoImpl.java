package com.rbkmoney.midgard.service.load.dao.impl;
...
import com.rbkmoney.midgard.service.load.dao.PaymentDao;
...
public class PaymentDaoImpl extends AbstractGenericDao implements PaymentDao {
    ...
    @Override
    public List<Long> save(List<Payment> payments) {
        return payments.stream()
                .map(payment -> save(payment))
