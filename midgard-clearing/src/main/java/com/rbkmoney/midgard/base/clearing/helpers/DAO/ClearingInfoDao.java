...
public class ClearingInfoDao extends AbstractGenericDao implements ClearingDao<ClearingEvent> {
     ...
     *
     * @param providerId банк, для которого необходимо произвести поиск
    ...
    /**
     * Получение списка клиринговых события с определенным статусом
     *
     * @param state статус клирингового события
     * @return список клиринговых событий
     */
