package com.rbkmoney.midgard.base.load.pollers.event_sink.party_mngmnt.contract;
...
public class ContractContractorIDChangedHandler extends AbstractClaimChangedHandler {
    ...
    public void handle(PartyChange change, Event event) {
        ...
        getClaimStatus(change).getAccepted().getEffects().stream()
            ...
            log.info("Start contract contractorChanged changed handling, eventId={}, partyId={}, contractId={}",
            ...
            log.info("Contract contractorID has been saved, eventId={}, partyId={}, contractId={}",
                    eventId, partyId, contractId);
        });
    }
}
